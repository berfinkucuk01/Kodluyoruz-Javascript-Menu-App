  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    allBtn.addEventListener('click', function() {
      ...
      menu.forEach(function(item) {
        menuItem.innerHTML += `
          <div class="menu-item col-lg-6 col-md-6 col-sm-12">
    ...
    koreaBtn.addEventListener('click', function() {
      menuItem.innerHTML='';
      const koreaMenu=menu.filter(function(item){
        if(item.category==='Korea'){
            menuItem.innerHTML +=`<div class="menu-item col-lg-6 col-md-6 col-sm-12">
            <img src="${item.img}" alt="menu item" class="photo">
            <div class="item-info">
              <header class="menu-title">
                <h4>${item.title}</h4>
    ...
    japanBtn.addEventListener('click',function(){
        menuItem.innerHTML='';
        const japanMenu=menu.filter(function(item){
    ...
    chinaBtn.addEventListener('click',function(){
        menuItem.innerHTML='';
        const chinaMenu=menu.filter(function(item){
